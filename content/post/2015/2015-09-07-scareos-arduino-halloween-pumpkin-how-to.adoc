+++
title = "ScareOS: Arduino Halloween Pumpkin How-to"
date = "2015-09-07T07:29:44"
lastmod = "2025-01-03T22:48:50"
draft = false
slug = "scareos-arduino-halloween-pumpkin-how-to"
wordpress_id = "224"
url = "/2015/09/07/scareos-arduino-halloween-pumpkin-how-to/"
categories = ["Blog"]
+++
image:/images/2015/09/IMG_1327.jpg[/images/2015/09/IMG++_++1327] Muhahahaha! Aaaaargh! Trick or Treat. Be so sweet. Give me something good to eat.
...
You can find the code and the Fritzing diagram at Github: https://github.com/mp911de/scare-os-halloween-iot.
...
++++
<iframe width="420" height="315" src="https://www.youtube.com/embed/ZoHyhjCuUWQ" frameborder="0" allowfullscreen></iframe>
++++

++++
<iframe width="420" height="315" src="https://www.youtube.com/embed/dUIu-4qToRM" frameborder="0" allowfullscreen></iframe>
++++

_Hint: The video interferences are some recording issues._

== Ingredients

You'll need:

* 1x Arduino (I used the http://www.adafruit.com/products/2378[Ardunino Mini Pro] because of its form factor)
* 1x http://www.amazon.com/SainSmart-HC-SR04-Ranging-Detector-Distance/dp/B004U8TOE6[Ultrasonic HC-SR04 Ranging Sensor]
* 2x http://www.adafruit.com/products/1050[8X8 LED Matrix with I2C Backpack]
* 1x http://www.adafruit.com/products/2133[Audio FX Sound Board - WAV/OGG Trigger with 2MB Flash]
* 1x 470µF Capacitor
* 1x 470Ω - 560Ω Resistor
* 1x 330Ω - 360Ω Resistor
* a http://www.adafruit.com/products/826[whole bunch] of wire connectors
* 1x http://www.adafruit.com/products/1314[Speaker]
* 1x http://www.adafruit.com/products/64[Breadboard] (or a circuit board)
...
link:/images/external/scare-os-halloween-iot/ScareOS.png[image:/images/external/scare-os-halloween-iot/ScareOS.png[Fritzing wiring diagram]]
...
link:/images/external/scare-os-halloween-iot/IMG_0591.JPG[image:/images/external/scare-os-halloween-iot/IMG_0591.JPG[Connected components]]

link:/images/external/scare-os-halloween-iot/IMG_0592.JPG[image:/images/external/scare-os-halloween-iot/IMG_0592.JPG[Closeup of the breadboard]]
...
. T04HOLDL: Snoring sound, plays as long as the trigger is held, therefore, the special suffix `HOLDL`
...
The code is located at Github in https://github.com/mp911de/scare-os-halloween-iot/blob/master/scare-os/scare-os.ino[scare-os/scare-os.ino]. You need two additional libraries:

* https://github.com/adafruit/Adafruit-LED-Backpack-Library[Adafruit-LED-Backpack-Library]
* https://github.com/adafruit/Adafruit-GFX-Library[Adafruit-GFX-Library]

The Adafruit site has a nice tutorial how to https://learn.adafruit.com/adafruit-all-about-arduino-libraries-install-use/arduino-libraries[install Arduino libraries].
...
The ranging sensor uses the physics of https://en.wikipedia.org/wiki/Speed_of_sound[speed of sound] to determine the distance. An ultrasonic sound is triggered and the microphone records the echo. The speed of sound in dry air is about one kilometer in 2.914 sec. Since the sound needs to hit an object that bounces it back, the way is crossed twice. This means, that the duration to measure the distance is `DISTANCE ++*++ Speed of Sound ++*++ 2`.
